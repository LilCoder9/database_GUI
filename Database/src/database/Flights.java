...
public class Flights extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adding.addRow(newAdds, adding.getColumns("flights"), "flights");
        updateTable();
    ...
    private void jButton2ActionPerformed(ActionEvent evt) throws SQLException {
        ...
        editing.editRow(newEdits, editing.getColumns("flights"), "flights");
        updateTable();
    }
    ...
    private void jButton3ActionPerformed (java.awt.event.ActionEvent evt) throws SQLException {
        ...
        deleting.deleteRow(delete, deleting.getColumns("flights"), "flights");
        updateTable();
    }
    ...
    private void updateTable() throws SQLException {
        ...
        int rows = bruh.getNumRows("flights");
        int columns = bruh.getNumColumns("flights");
        String[] columnNames = bruh.getColumns("flights");
        Object[][] data = bruh.getRowData("flights");
