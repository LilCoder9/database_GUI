 ...
 * @author xmanh
 */
public class Lodging extends javax.swing.JFrame {

    /**
     * Creates new form User
     */
    public Lodging() throws SQLException {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adding.addRow(newAdds, adding.getColumns("lodging"), "lodging");
        updateTable();

    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(ActionEvent evt) throws SQLException {
        Object[] newEdits = new Object[5];
        ...
        editing.editRow(newEdits, editing.getColumns("lodging"), "lodging");
        updateTable();
    }
    ...
    private void jButton3ActionPerformed (java.awt.event.ActionEvent evt) throws SQLException {
        ...
        deleting.deleteRow(delete, deleting.getColumns("lodging"), "lodging");
        updateTable();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lodging.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void updateTable() throws SQLException {
        ...
        int rows = bruh.getNumRows("lodging");
        int columns = bruh.getNumColumns("lodging");
        String[] columnNames = bruh.getColumns("lodging");
        Object[][] data = bruh.getRowData("lodging");
